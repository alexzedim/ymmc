          ...
          <div className="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div className="flex gap-4 items-center">
              <Button
                ...
                isExternal
                size="sm"
                className="px-4 py-2 rounded-full bg-white/10 dark:bg-white/5 backdrop-blur-md border border-white/20 dark:border-white/10 hover:bg-[#24292e]/10 dark:hover:bg-[#24292e]/20 transition-all shadow-sm hover:shadow-md flex items-center gap-2"
              >
              ...
              <Button
                ...
                isExternal
                size="sm"
                className="px-4 py-2 rounded-full bg-white/10 dark:bg-white/5 backdrop-blur-md border border-white/20 dark:border-white/10 hover:bg-[#5865F2]/10 dark:hover:bg-[#5865F2]/20 transition-all shadow-sm hover:shadow-md flex items-center gap-2"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                <span className={isDark ? "text-white" : "text-gray-900"}>Discord</span>
              </Button>
